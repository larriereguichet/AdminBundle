...
class LAGAdminExtension extends Extension implements PrependExtensionInterface
{
    public function load(array $configs, ContainerBuilder $container): void
    {
        ...
        if ($container->getParameter('kernel.environment') === 'dev') {
            $container->setDefinition(AdminDataCollector::class, new Definition())
                ->setArgument('$registry', new Reference(ResourceRegistryInterface::class))
                ->setArgument('$parametersExtractor', new Reference(ParametersExtractorInterface::class))
