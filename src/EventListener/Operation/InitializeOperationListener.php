...
class InitializeOperationListener
{
    ...
    public function __invoke(OperationEvent $event): void
    {
        ...
        if ($operation->getInputClass() === null & $resource->getInputClass() !== null) {
            $operation = $operation->withInputClass($resource->getInputClass());
        }

        if ($operation->getOutputClass() === null & $resource->getOutputClass() !== null) {
            $operation = $operation->withOutputClass($resource->getOutputClass());
        }
