...
final readonly class ResourceIdentifierMetadataFactory implements ResourceMetadataFactoryInterface
{
    ...
    {
        $metadata = $this->resourceMetadataFactory->createMetadata($resourceName);
